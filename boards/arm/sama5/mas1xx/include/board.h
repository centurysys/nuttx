...
#define PIO_FLEXCOM2_IO0  PIO_FLEXCOM2_IO0_1
#define PIO_FLEXCOM2_IO1  PIO_FLEXCOM2_IO1_1
#define PIO_FLEXCOM2_IO3  PIO_FLEXCOM2_IO3_1
#define PIO_FLEXCOM2_IO4  PIO_FLEXCOM2_IO4_1

#define PIO_FLEXCOM3_IO0  PIO_FLEXCOM3_IO0_3
#define PIO_FLEXCOM3_IO1  PIO_FLEXCOM3_IO1_3
#define PIO_FLEXCOM3_IO2  PIO_FLEXCOM3_IO2_3
#define PIO_FLEXCOM3_IO3  PIO_FLEXCOM3_IO3_3
#define PIO_FLEXCOM3_IO4  PIO_FLEXCOM3_IO4_3
...
#define PIO_FLEXCOM0_UART_DTR     (PIO_OUTPUT | PIO_CFG_DEFAULT | PIO_OUTPUT_CLEAR | \
                                   PIO_PORT_PIOC | PIO_PIN10)
#define PIO_FLEXCOM0_UART_DSR     (PIO_INPUT | PIO_CFG_DEFAULT | PIO_PORT_PIOC | PIO_PIN11)
#define PIO_FLEXCOM0_UART_DCD     (PIO_INPUT | PIO_CFG_DEFAULT | PIO_PORT_PIOC | PIO_PIN12)
#define PIO_FLEXCOM0_UART_RI      (PIO_INPUT | PIO_CFG_DEFAULT | PIO_PORT_PIOC | PIO_PIN13)

/* RS-485 is UART7 (FLEXCOM2).
 *
 */

#define PIO_UART7_RXD     PIO_FLEXCOM2_IO1
#define PIO_UART7_TXD     PIO_FLEXCOM2_IO0
#define PIO_FLEXCOM2_UART_TXEN    (PIO_OUTPUT | PIO_CFG_DEFAULT | PIO_OUTPUT_CLEAR | \
                                   PIO_PORT_PIOD | PIO_PIN30)
#define PIO_FLEXCOM2_UART_RXEN    (PIO_OUTPUT | PIO_CFG_DEFAULT | PIO_OUTPUT_CLEAR | \
                                   PIO_PORT_PIOD | PIO_PIN29)
