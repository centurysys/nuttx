/****************************************************************************
 * boards/arm/sama5/mas1xx/src/sam_usb.c
 *
...
#ifndef CONFIG_MAS1XX_USBHOST_PRIO
#  define CONFIG_MAS1XX_USBHOST_PRIO 50
#endif

#ifndef CONFIG_MAS1XX_USBHOST_STACKSIZE
#  define CONFIG_MAS1XX_USBHOST_STACKSIZE 1024
#endif
...
int sam_usbhost_initialize(void)
{
  ...
  ret = kthread_create("OHCI Monitor", CONFIG_MAS1XX_USBHOST_PRIO,
                       CONFIG_MAS1XX_USBHOST_STACKSIZE,
                       ohci_waiter, NULL);
  if (ret < 0)
    {
  ...
  ret = kthread_create("EHCI Monitor", CONFIG_MAS1XX_USBHOST_PRIO,
                       CONFIG_MAS1XX_USBHOST_STACKSIZE,
                       ehci_waiter, NULL);
  if (ret < 0)
    {
...
void sam_usbhost_vbusdrive(int rhport, bool enable)
{
  ...
  switch (rhport)
    ...
    case SAM_RHPORT1:
      ...
      /* MAS1XX has no port A VBUS enable */
