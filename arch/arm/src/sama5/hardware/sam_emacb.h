...
/* This is the form of the EMAC interface used the SAMA5D4 (and also the
 * SAM43). This is referred as GMAC in the documentation even though it does
 * not support Gibabit Ethernet.
 */
